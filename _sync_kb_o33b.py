"""Авто-синк base-дока knowledge_base в Brain (git = истина, Drive = зеркало) + сверка длины."""
import sys
...
r = b.write_doc(text, name="knowledge_base")
print("write:", r.get("ok"), r.get("error"))
rr = b._call("read_doc", name="knowledge_base")
