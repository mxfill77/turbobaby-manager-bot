...
# НАБЛЮДАЕМЫЕ: (юнит systemd, точка входа). Ровно два — те, что назвал разбор цели 355.
# `wa-webhook` сюда НЕ входит намеренно: список без реакции владельца растёт в шум (тот же
# довод, по которому его нет в списке ленты фазы 1). Расширять — отдельным решением.
