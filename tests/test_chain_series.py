...
# ПРЕДМЕТ ЭТОГО СЬЮТА — ПРЕЖНЕЕ ОПРЕДЕЛЕНИЕ ЧИСТОТЫ (обрыв = шум · ремонт · отказ). Правило
# зелёного (16.08.2026, RULE_ON_COUNT) считает по-другому и судится своим сьютом
