...
# ═══ (8) О5 «ДОЛЬШЕ БЮДЖЕТА» ═══
print("\n(8) мост ответил, но дольше отведённого: 207 с и 798 с звучат, 66 с и 2.9 с — нет")
res.append(ok(C["bridge_slow"] == 120.0, "(8) боевой бюджет одного вызова = 120 с"))
for dt, want, why in ((2.13, [], "медиана собственной пробы"),
                      (2.96, [], "max собственной пробы 10.08"),
                      (45.0, [], "p99 живого корпуса"),
                      (66.0, [], "max корпуса ниже пустого промежутка"),
                      (207.0, ["o5_bridge_slow"], "живой max корпуса 07.08"),
...
slow = E.verdict(facts(bridge=br_fact(dt=207.0, last_fast=NOW - 600)), C)[0]
snote = E.render(slow, "VPS")
print("      ЗАМЕТКА: %s" % snote)
res.append(ok("207 с" in snote and "120 с" in snote,
