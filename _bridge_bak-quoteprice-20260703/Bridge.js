    ...
    switch (action) {
      ...
      case 'get_pending':
        return jsonResponse(Object.assign({ action: 'get_pending' },
          getPending_({ status: params.status })));
...
function doPost(e) {
  try {
    ...
    var REDZONE_LOCK = {
      ...
      create_booking: 1, activate_booking: 1, delete_event: 1,
